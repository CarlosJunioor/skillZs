...
async function handle(req: Request) {
  // allowCronSecretFallback: scheduled by Vercel cron (vercel.json),
  // which auto-injects Authorization: Bearer $CRON_SECRET. The
  // DIPTYCH_CRON_SECRET still works for manual triggers from the backfill
  // script. Admin routes intentionally do NOT enable this fallback.
